...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$sql = "UPDATE `Stats` SET `TotalChars`=:Chars,`AverageChars`=:AvgChars,`BookCount`=:Count,`MostUsedWord`=:FavWord,`LongestBook`=:LongestBook,`LongestBookLength`=:LongestBookLength,`FavLicense`=:FavLicense,`Date`=NOW()";
	$stmt = $db->prepare($sql);
